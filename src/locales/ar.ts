export const ar = {
  ...
  logo: {
    ...
    remove: 'إزالة',
    sizeError: 'يجب أن يكون الشعار مربعًا وبحجم 100×100 بكسل على الأقل',
    fileSizeError: 'حجم الملف كبير جدًا. الحد الأقصى هو 1 ميجابايت',
    requirements: 'يجب أن يكون الشعار مربعًا، بحجم 100×100 بكسل على الأقل، وأقل من 1 ميجابايت'
  },
  preview: 'معاينة',
